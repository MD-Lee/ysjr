                ...
                <div class="row-fluid">
                        <div>
                           <div class="widgetbox personal-information">
                               <h4 class="widgettitle">调研列表</h4>
                               <div class="widgetcontent dataTables_wrapper">
                                   <table class="table">
                                   	<tr>                                    	
                                        <th width="50px">用户手机号</th>
                                   		<th width="50px">调研时间</th>
                                   		<th width="500px">详情</th>                                                                		
                                   	</tr>
                                   	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                                        	 
                                   			 <th width="150px"><?php echo ($vo["phone"]); ?></th>
	                                   		 <th width="150px"><?php echo ($vo["time"]); ?></th>
	                                   		 <th width="100px"><a href="<?php echo U('Article/xiangqing',array('phone'=>$vo['phone']));?>">详情</a></th>

                ...
                <div class="row-fluid">
                   <div>
                        <div class="widgetbox personal-information" id="info">
                            <h4 class="widgettitle">审核成员信息</h4>
                            <div class="widgetcontent">
                            	<table class="table table-bordered">
                            		...
                            		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            				...
                            				<td>
                            					...
                            					<a href="#" onclick="delete_examine(this)" id="<?php echo ($vo["id"]); ?>">删除</a>
                            				</td>
								...
								<div class="widgetbox personal-information" id="edit" style="display:none">
                                    <h4 class="widgettitle">添加审核成员</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Examine/edit_examine');?>" class="editprofileform" id="form">
	                                    		<p style="margin:0 0;">
                                            ...
                                            <p>
	                                        	<button class="btn btn-primary" onclick="edit_examine()">修改信息</button>
			                                </p>
                                    	</div>
                                    </div>
                                </div>
                                ...
                                <div class="widgetbox personal-information" style="display:none" id="pwd1">
                                	...
                                	<div class="widgetcontent">
	                                	<form id="password" action="<?php echo U('Examine/edit_pwd');?>">
	                                       	<p>
	                                            <label>旧密码：</label>
...
function edit(obj){
	...
	$.ajax({
		type:'POST',
		url:"<?php echo U('Examine/assignment');?>",
		data:{'id':id},
		datetype:'json',
...
function edit_examine(){
	$('#form').ajaxSubmit({
		...
		success:function(data){
			if(data == '修改成功'){
				alert(data);
				setTimeout(function(){window.location.href="<?php echo U('Examine/examine_list');?>"},1000);
			}
		}
	})
}

function delete_examine(obj){
	var id = obj.id;
	$.ajax({
		type:"POST",
		url:"<?php echo U('Examine/delete_examine');?>",
		data:{'id':id},
		datatype:"json",
		success:function(data){
			if(data == '删除成功'){

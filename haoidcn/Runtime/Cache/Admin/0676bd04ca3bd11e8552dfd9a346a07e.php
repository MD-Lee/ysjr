                   ...
                   <div>
                        <div class="widgetbox personal-information">
                            ...
                            <div class="widgetcontent">
                            	<form id="form" action="<?php echo U('Admin/search_bank_info');?>">
                            		<input type="text" class="input-xlarge" name="phone" placeholder="请输入要搜索的手机号码">
                            		<select name="bank_name">
								  		<option value="">银行</option>
									  	<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								  	</select>
                            	...
                            	<div id="tab1">
	                            	<table class="table table-bordered">
	                            		...
	                            		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                            				...
	                            				<td>
	                            					<?php if($vo["is_payment"] == 0): ?><a href="<?php echo U('Admin/shenghe',array('phone'=>$vo['phone']));?>">审核</a>

                ...
                <div class="row-fluid">
                        <div>
                           <div class="widgetbox personal-information">
                               <h4 class="widgettitle">用户留言</h4>
                               <div class="widgetcontent dataTables_wrapper">
                                   <table class="table">
                                   	<tr>                                    	
                                        <th width="50px">用户手机号</th>
                                   		<th width="50px">类型</th>
                                   		<th width="500px">留言内容</th>    
                                   		<th width="200px">留言时间</th>                                                             		
                                   	</tr>
                                   	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                                        	 
                                   			 <td width="150px"><?php echo ($vo["phone"]); ?></td>
	                                   		 <td width="150px"><?php echo ($vo["message"]); ?></td>
	                                   		 <td width="100px"><?php echo ($vo["content"]); ?></td>
	                                   		 <td width="100px"><?php echo ($vo["time"]); ?></td>

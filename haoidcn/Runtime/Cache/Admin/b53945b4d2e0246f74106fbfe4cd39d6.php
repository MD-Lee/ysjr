                                ...
                                <div class="widgetbox personal-information">
                                    ...
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Task/on_adopt');?>" id="form">
		                                    	<p style="margin:0 0;">
		                                            <div>手机号：<?php echo ($phone); ?></div>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <div>借款额度：<?php echo ($list['money_num']); ?></div>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <div>期限：<span id="time_length"><?php echo ($list['time_length']); ?></span></div>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                        	<div>实际放款额度：<?php echo ($list['daozhang']); ?></div>
		                                        </p>
		                                        <p style="margin:0 0;">

                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">添加常见问题</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Article/problem_method');?>" class="editprofileform" id="form">
	                                    		<p style="margin:0 0;">
		                                            <label>问题的标题：</label>
...
function problem_method(){
	...
	$('#form').ajaxSubmit({
		...
		success:function(data){
			alert(data);
			setTimeout(function(){window.location.href="<?php echo U('Article/problem_list');?>"},1000);
		}
	})
}
</script>

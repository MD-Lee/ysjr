                ...
                <div class="row-fluid">
                   <div>
                        <div class="widgetbox personal-information" id="list">
                            <h4 class="widgettitle">常见问题列表</h4>
                            <div class="widgetcontent">
                            	<table class="table table-bordered">
                            		<tr>
                            			<th width="200px;">常见问题的标题</th>
                            			<th width="200px;">常见问题的内容</th>
                            		...
                            		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            				...
                            				<td>
                            					<?php if($vo["top"] == 0): ?><a href="#" onclick="content_top(this)" id="<?php echo ($vo["id"]); ?>">置顶</a>
                            					<?php else: ?>
                            						已置顶<?php endif; ?>
                            					<a href="#" onclick="edit(this)" id="<?php echo ($vo["id"]); ?>">编辑</a>
                            					<a href="#" onclick="delete_content(this)" id="<?php echo ($vo["id"]); ?>">删除</a>
                            				</td>
                         ...
                         <div class="widgetbox personal-information" style="display:none" id="edit">
                               ...
                               <div class="widgetcontent">
                               	<div style="padding:15px 40px;">
                                	<form action="<?php echo U('Article/edit_content');?>" class="editprofileform" id="form">
                                		<p style="margin:0 0;">
                                         <label>问题的标题：</label>
...
function delete_content(obj){
	...
	$.ajax({
		type:"POST",
		url:"<?php echo U('Article/delete_content');?>",
		data:{'id':id},
		datatype:"json",
		success:function(data){
			alert(data);

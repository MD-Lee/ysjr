                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">编辑协议</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Article/edit_agreement');?>" class="editprofileform" id="form">
		                                    	<!-- UE编辑器 -->
												<div>
													<script type="text/plain" id="container" name="info[content]"><?php echo ($content); ?></script>
													<script  type="text/javascript">
														//实例化编辑器
														var ue = UE.getEditor('container');
														ue.ready(function() {
														    //设置编辑器的内容
														   // UE.getEditor('container').execCommand('insertHtml', "")
														});
													</script>
												</div>
                                            ...
                                            <p>
	                                        	<button class="btn btn-primary" onclick="edit_agreement()">修改协议</button>
			                                </p>
                                    	</div>
                                    </div>
                                </div>

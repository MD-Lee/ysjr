                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">续期配置</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Admin/add_xuqi');?>" id="form">
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">续期服务费：</label>
		                                            <input type="text" class="input-xlarge" name="info[xuqi]" value="<?php echo ($money); ?>"/>
		                                        </p>
		                                        <input type="hidden" value="<?php echo ($id); ?>" name="info[id]">
		                                    </form>
                                            <p>
	                                        	<button class="btn btn-primary" onclick="add_xuqi()">更新配置</button>
			                                </p>
                                    	</div>
                                    </div>
                                </div>

                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">逾期配置</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Admin/add_overdue');?>" id="form">
		                                    	<p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">逾期罚金：</label>
		                                            <input type="text" class="input-xlarge" name="info[interest]" value="<?php echo ($interest); ?>"/>
		                                        </p>

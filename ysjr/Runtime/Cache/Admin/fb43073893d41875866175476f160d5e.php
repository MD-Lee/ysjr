                            ...
                            <div class="widgetcontent" id="user" style="height: 2500px;">
                            	<div style="float:left;margin-top: -15px;">
	                            	...
	                            	<?php else: ?>
		                            	...
		                            	<?php if($xuesheng['url'] != null): ?><p>
			                            		<a href="<?php echo ($xuesheng['url']); ?>" target="_blank"><img src="<?php echo ($xuesheng['url']); ?>" style="width:600px;height:300px"></a>
			                            	</p><?php endif; ?>
		                            	<?php if($bank['img'] != null): ?><p>
			                            		<a href="<?php echo ($bank['img']); ?>" target="_blank"><img src="<?php echo ($bank['img']); ?>" style="width:600px;height:300px"></a>
			                            	</p><?php endif; endif; ?>
                            	</div>
                            	...
                            	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="margin-left:750px;">
								  ...
								  <div class="panel panel-default">
								    ...
								    <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
								      <div class="panel-body">
								      		<?php if($bank == null): ?>未绑定银行卡
								      		<?php else: ?>
								      		<p><span>持卡姓名：</span><span><?php echo ($bank['name']); ?></span></p>
								      		<p><span>银行卡名称：</span><span><?php echo ($bank['bank_name']); ?></span></p>
											<p><span>银行卡号：</span><span><?php echo ($bank['bank_num']); ?></span></p>
											<p><span>开户行网点：</span><span><?php echo ($bank['account_opening']); ?></span></p><?php endif; ?>
								      </div>
								    </div>
								  </div>
								  <div class="panel panel-default">
								    <div class="panel-heading" role="tab" id="headingsix">
								      <h4 class="panel-title">
								        <a class="button" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
								          	借款信息
								        </a>
								      </h4>
								    </div>
								    <div id="collapsesix" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingsix">
								      <div class="panel-body">
			                            	...
			                            	<?php if($fangkuan != null): ?><p><span>已经扣除相关费用</span></p><?php endif; ?>
			                            	<p><span>服务密码：</span><span><?php echo ($list[0]['service_pwd']); ?></span></p>
			                            	<p>
			                            	<span>状态：</span>
			                            	<span>
			                            	<?php if($list[0]['is_adopt'] == -1): ?>未完善个人资料
                           					<?php elseif($list[0]['is_adopt'] == 0): ?>
                           						<span style="color:red">申请中</span>
                           					<?php elseif($list[0]['is_adopt'] == 1): ?>
                           						<?php if($bank['is_payment'] == 0): ?>验证银行卡
                           						<?php elseif($bank['is_payment'] == 1): ?>
                           							等待放款
                           						<?php elseif($bank['is_payment'] == 2): ?>
                           							银行卡验证失败
                           						<?php else: ?>
                           						初审通过<?php endif; ?>
			                            	...
			                            	<p>
			                            	<?php if($list[0]['loan_people'] == null): else: ?>
			                            	<span>审核人员：</span><span><?php echo ($list[0]['loan_people']); ?></span><?php endif; ?>
			                            	</p>
			                            	<p>
			                            	<?php if($list[0]['is_renewal'] == 0): else: ?>
			                            	<span>续期：</span><span><?php echo ($list[0]['is_renewal']); ?></span><?php endif; ?>
			                            	</p>
								      </div>
								    </div>
								  </div>
...
function user_search(){
	...
	$('#form').ajaxSubmit({
		...
		success:function(data){
			$.each(data,function(){
				$('#table').append("<tr><td>"+this.uname+"</td><td>"+this.phone+"</td><td>"+this.time+"</td></tr>")
			});

                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">资料配置</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Admin/edit_admin_data');?>" id="form">
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">出借人：</label>
		                                            <input type="text" class="input-xlarge" name="info[name]" value="<?php echo ($list['name']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">出借人身份证：</label>
		                                            <input type="text" class="input-xlarge" name="info[uid]" value="<?php echo ($list['uid']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">公司：</label>
		                                            <input type="text" class="input-xlarge" name="info[company]" value="<?php echo ($list['company']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">地址：</label>
		                                            <input type="text" class="input-xlarge" name="info[address]" value="<?php echo ($list['address']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">联系电话：</label>
		                                            <input type="text" class="input-xlarge" name="info[mobile]" value="<?php echo ($list['mobile']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">邮箱：</label>
		                                            <input type="text" class="input-xlarge" name="info[mailbox]" value="<?php echo ($list['mailbox']); ?>"/>
		                                        </p>
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">支付宝账号：</label>
		                                            <input type="text" class="input-xlarge" name="info[account_num]" value="<?php echo ($list['account_num']); ?>"/>
		                                        </p>
		                                        <input type="hidden" value="<?php echo ($id); ?>" name="info[id]">
		                                    </form>
                                            <p>
	                                        	<button class="btn btn-primary" onclick="add_overdue()">更新配置</button>
			                                </p>
                                    	</div>
                                    </div>
                                </div>

                   ...
                   <div>
                        <div class="widgetbox personal-information">
                            ...
                            <div class="widgetcontent" id="user" style="height: 700px;">
                            	<div style="float:left;margin-top: -15px;">
	                            	<?php if($list['img'] == null): ?><span>图片:</span>
	                            		<span>没有银行卡截图</span>
	                            	<?php else: ?>
		                            	<p>
		                            		<a href="<?php echo ($list['img']); ?>" target="_blank"><img src="<?php echo ($list['img']); ?>" style="width:600px;height:600px"></a>
		                            	</p><?php endif; ?>
                            	</div>
								  ...
								  <div class="panel panel-default">
								    ...
								    <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
								      <div class="panel-body">
								      		<p><span>姓名：</span><span><?php echo ($list['name']); ?></span></p>
								      		<p><span>手机号：</span><span><?php echo ($list['phone']); ?></span></p>
								      		<p><span>银行卡名称：</span><span><?php echo ($list['bank_name']); ?></span></p>
											<p><span>银行卡号：</span><span><?php echo ($list['bank_num']); ?></span></p>
											<p><span>开户网点：</span><span><?php echo ($list['account_opening']); ?></span></p>
											<p><span>审核人员：</span><span><?php echo ($list['loan_people']); ?></span></p>
								      </div>
								    </div>
								  </div>
								  
								  <button type="button" class="btn btn-primary" onclick="is_bank(this)" value="" id="<?php echo ($phone); ?>">通过</button>
                        ...
                        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						  ...
						  <div class="modal-footer">
						    ...
						    <button type="button" class="btn btn-primary" onclick="no_bank(this)" id="<?php echo ($phone); ?>" aria-hidden="true" data-dismiss="modal">确定</button>
						  </div>
						</div>
                    </div><!--row-fluid-->

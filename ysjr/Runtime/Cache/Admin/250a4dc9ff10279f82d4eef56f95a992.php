                ...
                <div class="row-fluid">
                   <div>
                        <div class="widgetbox personal-information">
                            <h4 class="widgettitle">逾期名单</h4>
                            <div class="widgetcontent">
                            	<form id="form" action="<?php echo U('Transaction/overdue');?>" method="post">
                            	...
                            	<table class="table table-bordered">
                            		<tr>
                            			...
                            			<th width="200px;">约定还款日期</th>
                            			<th width="200px;">逾期天数</th>
                            			<th width="200px;">逾期罚金</th>
                            		...
                            		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                            			...
	                            			<td width="100px;"><?php echo ($vo["money_num"]); ?>元</td>
	                            			<td width="100px;"><?php echo ($vo["time_length"]); ?>天</td>
	                            			<td width="200px;"><?php echo ($vo["appoint_time"]); ?></td>
	                            			<td width="200px;"><?php echo ($vo["yuqi_time"]); ?>天</td>
	                            			<td width="200px;"><?php echo ($vo["money"]); ?>元</td>
	                            			<td width="200px;"><?php echo ($vo["loan_people"]); ?></td>

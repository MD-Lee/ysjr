                ...
                <div class="row-fluid">
                        <div>
                                ...
                                <div class="widgetbox personal-information">
                                    <h4 class="widgettitle">到期提醒配置</h4>
                                    <div class="widgetcontent">
                                    	<div style="padding:15px 40px;">
	                                    	<form action="<?php echo U('Daoqi/add_daoqi');?>" id="form">
		                                        <p style="margin:0 0;">
		                                            <label style="float:left;margin-top: 5px;">提前：</label>
		                                            <input type="text" class="input-xlarge" name="info[days]" value="<?php echo ($days); ?>" placeholder="输入提前几天提醒用户到期"/>
		                                        </p>
		                                        <input type="hidden" value="<?php echo ($id); ?>" name="info[id]">
		                                    </form>
                                            <p>
	                                        	<button class="btn btn-primary" onclick="add_daoqi()">更新配置</button>
			                                </p>
                                    	</div>
                                    </div>
                                </div>
